...
geth15 --datadir qdata/dd1 init genesis.json
...
geth15 --datadir qdata/dd2 init genesis.json
...
geth15 --datadir qdata/dd3 init genesis.json
...
geth15 --datadir qdata/dd4 init genesis.json
...
geth15 --datadir qdata/dd5 init genesis.json
...
geth15 --datadir qdata/dd6 init genesis.json
...
geth15 --datadir qdata/dd7 init genesis.json
